...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-lg border border-input bg-background/50 px-4 py-2 text-sm",
  ...
  <SelectPrimitive.Portal>
    <AnimatePresence>
      <SelectPrimitive.Content
        ref={ref}
        className={cn(
          "relative z-50 max-h-[300px] min-w-[8rem] overflow-hidden rounded-lg border bg-popover/95 text-popover-foreground shadow-lg",
          "backdrop-blur-sm",
      ...
      >
        ...
        >
          ...
          <SelectPrimitive.Viewport
            ...
            style={{
              maxHeight: "250px" // Increased viewport height
            }}
          >
            {children}
          </SelectPrimitive.Viewport>
